...
#git clone https://github.com/destan19/openfros.git package/luci-app-openfors
#git clone https://github.com/kiddin9/openwrt-packages.git package/openwrt-packages
#git clone https://github.com/kinsum666/luci-app-unblockneteasemusic.git package/unblcoknetasemusic
